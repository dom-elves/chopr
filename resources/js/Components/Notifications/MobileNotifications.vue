...
<template>
    <div>
        <div 
            class="flex flex-row items-center justify-between text-start text-base font-medium focus:outline-none transition duration-150 ease-in-out block w-full ps-3 pe-4 py-2 border-l-4" 
            :class="classes" 
            @click="active = !active"
        >
            <p>Notifications</p>
